...
const introMessages = [
  ...
  "สิ่งนี้ตั้งใจทำขึ้นมาเพื่อวันเกิดของนิ้งเลย",
  "ก่อนอื่นก็",
  "เรามาเริ่ม...",
  "ดูรูปภาพความทรงจำด้วยกันนะ",
];
...
const photoGallery = [
  {
    ...
    caption:
      "9 สิงหาคม 2024 \nจำได้มั้ยวันนี้เป็นวันที่นิ้งบอกให้มาช่วยแก้แลปพอนิ้งบอก\nก็รีบมาทันที่เลย แอบถ่ายรูปนิ้งตอนทำแลปด้วย นิ้งตั้งใจทำมากๆ",
  },
  {
    id: 2,
    src: "/86649_0.jpg?height=800&width=600&text=Memory+2",
    caption:
      "4 กันยายน 2024\n วันนี้เป็นวันที่เราทำงานกลุ่มด้วยกันแล้วก็เป็นวันที่เรานั่งเรียนด้วยกัน\nนิ้งดูง่วงมาก55555",
  },
  {
    id: 3,
    src: "/86648_0.jpg?height=800&width=600&text=Memory+3",
    caption:
      "8 ตุลาคม 2024 \n เป็นวันที่นิ้งมาหาที่โรงอาหารด้วย ตอนนั้นขอนิ้งจับมือ \n ดีใจมากๆ",
  },
  {
    id: 4,
    src: "/86647_0.jpg?height=800&width=600&text=Memory+4",
    caption:
      "12 ตุลาคม 2024 \n วันนี้ส่งภาพให้นิ้งช่วยเลือกรองเท้าให้ \n ชอบรองเท้าที่เลือกให้มากๆ",
  },
  {
    id: 5,
    src: "/86646_0.jpg?height=800&width=600&text=Memory+5",
    caption:
      " 13 ตุลาคม 2024 \n จำได้มั้ยวันนี้ที่ขับรถไปด้วยกันแล้วก็เป็นวันแรกที่เราดูหนังด้วยกัน \n โรง 1 E7,E8 หลังจากดูหนังเสร็จ ก็ไปเดินงานด้วยกันโดนแอบถ่ายรูปตอนกินข้าวด้วยกันด้วย55555",
  },
  {
    id: 6,
    src: "/86645_0.jpg?height=800&width=600&text=Memory+6",
    caption:
      "15 ตุลาคม 2024 \nวันนี้ไปกินก๋วยเตี๋ยวกับนิ้งแล้วก็เป็นครั้งแรกที่เรานั่งกินบิงชูด้วยกันหวานมากๆ",
  },
  {
    id: 7,
    src: "/86644_0.jpg?height=800&width=600&text=Memory+7",
    caption:
      "23 ธันวาคม 2024 \nเราขับมอไซน์ไปเที่ยวงานแห่ดาวที่ท่าแร่ด้วยกันอากาศหนาวมากๆ\nจนตัวแข็งเลย แล้วเจอครูไพบูนด้วย55555 \n อยากไปด้วยกันอีกนะ",
  },
  {
    id: 8,
    src: "/86643_0.jpg?height=800&width=600&text=Memory+8",
    caption:
      "4 มกราคม 2025 \nเป็นครั้งแรกเลยที่มากินหมูกระทะด้วยกัน ดูสายตานิ้งสิ55555 \n มีความสุขมากๆเลยหล่ะวันนั้น เสียดายจังที่ไม่ได้แกะกุ้งให้",
  },
  {
    id: 9,
    src: "/86642_0.jpg?height=800&width=600&text=Memory+9",
    caption:
      "14 กุมภาพันธ์ 2024 \nของขวัญวันวาเลนไทน์ที่นิ้งพับกระดาษเป็นรูปดาวให้ \n ดีใจมากๆเลยนะที่ได้ของชิ้นนี้จากนิ้ง",
  },
  {
    id: 10,
    src: "/86651.jpg?height=800&width=600&text=Memory+10",
    caption: "28 สิงหาคม 2025 \n สุขสันต์วันเกิดคนที่ผมรักมากที่สุด",
  },
];
...
const finalWishes = [
  ...
  "เติบโตขึ้นอีกแล้ว 1 ปี  ขอให้ความฝันของนิ้งเป็นจริง ",

  "จะคอยซัพพอร์ตทุกเรื่องราวของนิ้งเสมอ   ",
  "ขอให้มีแต่เรื่องราวดีสิ่งดีๆเข้ามาในชีวิต",
          ...
          >
            {finalWishes.slice(0, currentWish).map((wish, index) => (
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className={`${sriracha.className} text-xl sm:text-2xl md:text-3xl lg:text-1xl font-bold text-pink-600 leading-relaxed`}
              >
                {wish}
              </motion.p>
            ))}
